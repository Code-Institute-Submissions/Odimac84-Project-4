...
from.views import (
    HomeView, PostView, Add_BlogEntry,
    Edit_BlogEntry, Delete_Entry, Add_Category,
    View_By_Category, LikeView, Add_Comment)
...
urlpatterns = [
    ...
    path(
        'article/edit/<int:pk>', Edit_BlogEntry.as_view(),
        name='edit-blogentry'),
    path(
        'article/<int:pk>/delete', Delete_Entry.as_view(),
        name='delete-entry'),
